...
export function SecondGrid() {
    ...
    useEffect(() => {
        ...
        const res = await fetch('/api/datavisualization',{
            method: 'GET'
        })
        ...
        <div className="bg-white-100 border-b border-slate-350 grid grid-cols-12 gap-3 p-4">
            <div className="col-span-12">
                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-3">
                        ...
                        <div className="flex justify-between items-center mt-2 mb-4"> 
                            <div className="flex flex-col gap-4">
                                <div className="flex items-center gap-2">
                                    <h4 className="text-xl text-black">Low Stock Items Count:</h4>
                                    <p className="text-slate-500 text-xl font-semibold">4</p>
                                </div>
                                <div className="flex items-center gap-2">
                                    <h4 className="text-xl text-black">All Items:</h4>
                                    <p className="text-slate-500 text-xl font-semibold">65</p>
                                </div>
                            </div>
                            <div className="w-2/5">
                    ...
                    <div className="shadow-lg col-span-12 md:col-span-6 rounded-lg border border-slate-200 bg-white py-6 px-4 cursor-pointer flex flex-col gap-4 justify-between min-w-0">
                        <h2 className="uppercase text-black text-base font-semibold">Top Selling Items</h2>
