    ...
    return(
        <div className="w-full h-48 bg-white dark:bg-slate-900 shadow-md rounded-xl bg-14 md:bg-contain bg-aibg bg-right-bottom bg-no-repeat">
            <div className="flex flex-col p-6">
                ...
                <span className="block md:inline-block">engines faster</span> </p>
                <p className="text-red-900 font-sans font-extrabold text-md md:text-xl">with Artificial <span className="">Intelligence</span> </p>
            </div>
        </div>
    )
}