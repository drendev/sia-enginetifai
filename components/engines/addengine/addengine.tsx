...
const AddEngineForm = () => {
  ...
  const { setValue, handleSubmit, formState: { errors } } = useForm<z.infer<typeof FormSchema>>({
    ...
    defaultValues: {
      ...
      EngineOilCapacity: undefined, Size: undefined, ContinuousOpHours: undefined, Type: undefined, RunningTime: undefined, Optional: undefined,
      NoLoadVoltage: undefined, OperatingWelding: undefined, OperatingCurrent: undefined, MaxArcingCurrent: undefined, DutyCycle: undefined, EngineRatedPower: undefined,
      TillingWidth: undefined, TransmissionMode: undefined, PackingSize: undefined, TillingDepth: undefined, ShiftingGears: undefined, TransportingWheel: undefined,
      TillingBlades: undefined, ContLoad20: undefined, ContLoad40: undefined, NetPower: undefined, DisplacementBore: undefined, EngineType: undefined, Weight: undefined
    },
  });
