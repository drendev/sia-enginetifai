...
export async function POST(req: Request) {
    try {
        ...
        const transactionWithPictures = {
            ...getTransaction,
            pictures: pictures,
            address: getTransaction.deliveryInformation?.address,
            deliveryUser: getTransaction.deliveryInformation?.deliveryUser,
            deliveryStatus: getTransaction.deliveryInformation?.deliverStatus,
            deliveryTime: getTransaction.deliveryInformation?.deliveryTime,
        };
